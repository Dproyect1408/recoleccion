...
Partial Class _Default
    ...
    Private Sub _Default_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        SqlDataSource2.SelectCommand = "SELECT dbo.tt_lista.Id, dbo.tt_cliente.cliente, dbo.tt_cliente.telefono, dbo.tt_cliente.direccion, dbo.tt_cliente.num_casa, dbo.tt_lista.orden FROM dbo.tt_lista INNER JOIN dbo.tt_cliente ON dbo.tt_lista.id_cliente = dbo.tt_cliente.Id and dbo.tt_lista.chofer=1 ORDER BY dbo.tt_lista.orden asc"
