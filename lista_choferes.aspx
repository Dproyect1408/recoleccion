<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lista_choferes.aspx.vb" Inherits="_Default" %>
                                            ...
                                            <asp:DataList ID="DataList1" runat="server" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyField="Id" GridLines="Both" Width="100%" Height="309px" CellSpacing="2">
                                                ...
                                                <ItemTemplate>
                                                    <table style="width:100%;">
                                                        <tr>
                                                            <td style="width: 10%"  >  
                                                                <asp:Button ID="Button6" runat="server" Text="Chofer 1" CommandName="captura" Font-Bold="True" ForeColor="#009933" />
                                                            </td>
                                                            <td style="width: 10%">
                                                                <asp:Button ID="Button7" runat="server" CommandName="captura" Font-Bold="True" ForeColor="#009933" Text="Chofer 2" />
                                                            </td>
                                                          <td style="width: 50%"  >  
