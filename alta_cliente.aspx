<%@ Page Language="VB" AutoEventWireup="false"  EnableEventValidation="false"  CodeFile="alta_cliente.aspx.vb" Inherits="_Default" %>
				...
				<div class="container">
					...
					<div class="row" style="text-align: center">
                                      ...
                                      <asp:DataList ID="DataList1" runat="server" Width="100%" DataKeyField="Id" DataSourceID="SqlDataSource3" CellPadding="4" ForeColor="#333333">
                                          ...
                                          <ItemTemplate>
                                              <table style="width:100%;">
                                                  <tr>
                                                      <td class="auto-style5">
                                                          <asp:Button ID="Button4" runat="server" CommandName="captura" Text="Aqui abajo" />
                                                      </td>
                                                      <td class="auto-style5">
                     ...
                     <asp:Button ID="Button2" runat="server" Text="Guardar" Width="166px" Height="45px"  class="primary-btn text-uppercase" CssClass="auto-style1" Visible="False"/>
                        ...
                        &nbsp;
                     <asp:Button ID="Button5" runat="server" Text="Guardar al final" Width="166px" Height="45px"  class="primary-btn text-uppercase" CssClass="auto-style1"/>
