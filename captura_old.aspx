<%@ Page Language="VB" AutoEventWireup="false" CodeFile="captura_old.aspx.vb" Inherits="_Default" %>
				...
				<div class="container">
					...
					<div class="row">
                        ...
                        <asp:Label ID="Label5" runat="server" Text="Cliente" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                                ...
                                <asp:DropDownList ID="ddl_cliente" runat="server" DataSourceID="SqlDataSource2" DataTextField="Expr1" DataValueField="Expr2" Font-Size="XX-Large" Height="86px" Width="691px">
