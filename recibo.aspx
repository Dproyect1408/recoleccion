<%@ Page Language="VB" AutoEventWireup="false" CodeFile="recibo.aspx.vb" Inherits="_Default" %>
			...
			<section class="banner-area relative">
				...
				<div class="container">
					...
					<div class="row">
                     ...
                     <asp:Button ID="Button2" runat="server" Text="Abonar" Width="25%"  class="primary-btn text-uppercase" CssClass="auto-style1" Height="123px" Font-Size="X-Large" ForeColor="#00CC00"/>
                                <asp:Button ID="boton"  runat="server" Text="pdf" CssClass="auto-style1" />
                                <br />
                                <br />
